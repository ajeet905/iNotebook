...
const JWT_SECRET = 'Sujeetisagoodb$oy';
...
router.post('/createuser', [
    ...
    let success = false;
    // if they are errors, retrun bad arequest and the errors 
...
router.post('/login', [
    ...
    try {
        ...
        if (!passwordCompare) {
            success = false
            return res.status(400).json({ success, error: "Please try to password with correct credentials" });
        }
